...
# 모델 평가 수행 함수
def evaluate_saved_models_with_confusion_matrix(model_names, test_loaders_dict, num_classes, model_paths, output_dir):
    ...
    results_csv_path = os.path.join(output_dir, f'{datetime.now().strftime("%Y%m%d%H%M%S")}_all_evaluation_results.csv')
...
if __name__ == '__main__':
    ...
    evaluate_saved_models_with_confusion_matrix(model_names, test_loaders_dict, num_classes, model_paths, output_dir)
