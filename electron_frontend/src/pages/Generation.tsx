    ...
    <div className="flex h-[calc(100vh-60px)] bg-gray-100 dark:bg-gray-800">
      ...
      >
        <nav className="flex flex-col items-center space-y-6">
          ...
          >
            <FaImage className="text-xl dark:text-slate-400" />
            <span className="text-xs mt-1 dark:text-slate-400">Txt2Img</span>
          </Link>
          <Link
            to="image-to-image"
            className="flex flex-col items-center text-gray-500 hover:text-gray-900 hover:bg-gray-200 transition duration-300 px-4 w-full py-2"
          >
            <FaMagic className="text-xl dark:text-slate-400" />
            <span className="text-xs mt-1 dark:text-slate-400">Img2Img</span>
          </Link>
          <Link
            to="inpainting"
            className="flex flex-col items-center text-gray-500 hover:text-gray-900 hover:bg-gray-200 transition duration-300 px-4 w-full py-2"
          >
            <FaPaintBrush className="text-xl dark:text-slate-400" />
            <span className="text-xs mt-1 dark:text-slate-400">Inpaint</span>
          </Link>
          <Link
            to="remove-background"
            className="flex flex-col items-center text-gray-500 hover:text-gray-900 hover:bg-gray-200 transition duration-300 px-4 w-full py-2"
          >
            <FaEraser className="text-xl dark:text-slate-400" />
            <span className="text-xs mt-1 text-center dark:text-slate-400">
              Remove BG
            </span>
          </Link>
          <Link
            ...
            className="flex flex-col items-center text-gray-500 hover:text-gray-900 hover:bg-gray-200 transition duration-300 px-4 w-full py-2"
          >
            <FaTrash className="text-xl dark:text-slate-400" />
            <span className="text-xs mt-1 dark:text-slate-400">Cleanup</span>
          </Link>
        </nav>
      </div>
