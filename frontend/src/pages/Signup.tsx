...
type FormType = signUpFormType & { verifyCode: string };
...
const Signup = () => {
  ...
  } = useForm<FormType>({ mode: 'onChange', defaultValues });
  ...
  if (isError) return <div>Error: {error?.message}</div>;
    ...
    return (
      <div className="w-full h-full relative overflow-hidden bg-white dark:bg-gray-800">
        ...
        <section className="flex flex-col items-center mt-[120px] mb-10">
          ...
          >
            ...
            <div>
              <button
                type="submit"
                className="w-[400px] h-[50px] bg-blue-500 text-white rounded-lg mt-10 disabled:opacity-50"
